        ...
        switch (position) {
            case 0:
                Glide.with(viewHolder.itemView)
                        .load("http://backend.waserbanura.com/apipaycon/3111/asset/food/favorite/NUA00012MN000012.jpg")
                        .fitCenter()
                        .into(viewHolder.imageViewBackground);
                break;
            case 1:
                Glide.with(viewHolder.itemView)
                        .load("http://backend.waserbanura.com/apipaycon/3111/asset/food/favorite/NUA00000MN000004.jpg")
                        .fitCenter()
                        .into(viewHolder.imageViewBackground);
                break;
            case 2:
                Glide.with(viewHolder.itemView)
                        .load("http://backend.waserbanura.com/apipaycon/3111/asset/food/favorite/PF00016MN000010.png")
                        .fitCenter()
                        .into(viewHolder.imageViewBackground);
                break;
            case 3:
                Glide.with(viewHolder.itemView)
                        .load("http://backend.waserbanura.com/apipaycon/3111/asset/food/favorite/NUA00000MN000006.jpg")
                        .fitCenter()
                        .into(viewHolder.imageViewBackground);
                break;
        }
